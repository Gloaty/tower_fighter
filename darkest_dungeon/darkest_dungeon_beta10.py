...
if ruby_random <= ruby_percentage > 1:
    abnormal_inventory = "Ruby"

sapphire_percentage = 7
sapphire_random = random.randrange(0, 100)
if sapphire_random <= sapphire_percentage > 5:
    abnormal_inventory = "Sapphire"

emerald_percentage = 10
emerald_random = random.randrange(0, 100)
if emerald_random <= emerald_percentage > 7:
