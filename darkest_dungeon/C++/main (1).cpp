...
int main()
{
    ...
    else if (inventory == "Minor Antique") {
        gold = gold + 500;   
    }
    else if (inventory == "Rare Antique") {
        gold = gold + 1250;   
    }
    else if (inventory == "Large Antique") {
        gold = gold + 1500;
    }
    else if (inventory == "Jute Tapestry") {
        gold = gold + 1750;   
    }
    else if (inventory == "Puzzling Trapezohedron") {
        gold = gold + 2500;   
    }
