...
void goldCheck() {
    ...
    string farmstead_enemy;

    void generateEnemy() {
        string area_choice;
        if (area_choice != "F") {
            string bandit_spawn[5] = { "Bandit", "Bandit Gunner", "Bandit Dog", "Bandit Leader", "Bandit Thief" };
            string supernatural_spawn[1] = { "fill this in later"};
        }
        else if (area_choice == "F") {
            string astral_spawn[5] = { "Eternal Labourer", "Astral Horse", "Millmaster", "Scarecrow", "Foreman" };
            string farmstead_enemy = astral_spawn[farmstead_enemy_RanIndex];
            cout << "Enemy: " << farmstead_enemy << endl;
        }
    }
...
int main()
{
    ...
    cout << "Gold: " << gold;if (inventory == "250 Gold") {
        gold = gold + 250;
    }
                                        ...
                                        farmstead:{
                                            ...
                                            if (farmstead_enter == "Y") {
                                                ...
                                                while (eternal_harvest == true) {
                                                    ...
                                                    farmstead_combat:{
                                                        generateEnemy();
                                                        cout << "A terrible " << farmstead_enemy << " awakens from the astral light. " << "\n";
