...
if save == "Y":
    ...
    while True:
        ...
        if old_road1 == "Y":
            ...
            if old_road_tent == "N":
                print("Wary of what may be inside, Reynauld and Dismas ignore the tent and push forward towards fhe next room. ")
            if old_road_tent == "Y":
                ...
                if old_road_fight == "Y":
                    ...
                    while True:
                        ...
                        if crusader_options == "A":
                            herodamage = random.randrange(3, 6)
                            crit_chance = 5
                        ...
                        if crusader_options == "G":
                            crusader_prot = 10
                            prot_damage_removal = monster_damage / crusader_prot
                            monster_damage = monster_damage - prot_damage_removal
                        highwayman_options = input("It is " + highwayman + "'s turn. What does " + highwayman + " do? Attack (A) Guard (G)")
                        if highwayman_options == "A":
                            print(highwayman + " has two weapons. Thos weapons are a gun and a dagger. ")
