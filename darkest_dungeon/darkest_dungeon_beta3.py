...
if save == "y":
    ...
    print(" ")
    while True:
        old_road1 = input("You are currently in a room. This room is empty. Head to the right? (Y/N)")
        if old_road1 == "Y":
            print("Reynauld and Dismas push forward, towards the hamlet. They discover an abandoned tent along the way. Investigate? (Y/N)")
        if old_road1 == "N":
