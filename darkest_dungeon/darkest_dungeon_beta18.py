            ...
            if old_road_tent == "Y":
                ...
                if old_road_fight == "Y":
                    ...
                    if monster_options == "Point Blank Shot":
                        ...
                        place_1_hero = crusader_health
                        place_2_hero = highwayman_health
                        ...
                        print(random_target)
                        if random_target == 1:
                            place_1_hero = crusader(int(crusader_health))
                            monster_damage = random.randrange(3, 7)
                            if monster_crit_random <= monster_crit_chance:
                                monster_damage = 8
                        elif random_target == 2:
                            place_2_hero = highwayman(highwayman_health)
                            monster_damage = random.randrange(3, 7)
                            if monster_crit_random <= monster_crit_chance:
                                monster_damage = 8
                    ...
                    while True:
                        ...
                        if crusader_options == "A":
                            herodamage = random.randrange(6, 10)
                            crit_chance = 5
